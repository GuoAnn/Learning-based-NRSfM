...
from NRSfM_core.curve_utils import fit_surface
from NRSfM_core.guard import guard_sqrt
...
def rescale_input_outputs(scales, output, points, control_points, batch_size):
    ...
    #for j in range(20):
    #    ax.scatter(control_points[0][j][:,0], control_points[0][j][:,1], control_points[0][j][:,2])
