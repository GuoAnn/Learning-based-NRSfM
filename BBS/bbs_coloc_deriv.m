function mat = bbs_coloc_deriv(bbs, u, v, du, dv)
%bbs_coloc_deriv Build a colocation matrix with derivatives of the basis 
%functions.
%
% mat = bbs_coloc_deriv(bbs, u, v, du, dv)
%
...
% "bbs_coloc_deriv" is similar to "bbs_coloc" except that this one is able
% to put derivatives of the B-spline basis functions.
%
% INPUT ARGUMENTS
%
...
%
%   du, dv [scalars]: Derivation order along the u- and v- direction
%   respectively.
%
% OUTPUT ARGUMENTS
%
