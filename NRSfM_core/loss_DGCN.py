...
from NRSfM_core.utils import chamfer_distance, chamfer_distance_one_side
...
def spline_reconstruction_loss_one_sided(nu, nv, output, points, batch_size, grid_size, side=1):
    """
    ...
    reconst_points = reconst_points.view(batch_size, grid_size_u * grid_size_v, 3)
